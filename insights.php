...
<section class="e-hero e-hero-video">
  ...
  <div class="wrap">
    ...
    <h1 class="rise d1">Privacy, plainly <em>put</em><span class="dot">.</span></h1>
    <p class="rise d2">Short, practical guidance on the data protection and AI governance questions UK businesses actually ask &mdash; written without the legalese.</p>
  </div>
</section>
...
<section class="e-section">
  <div class="wrap">
    <div class="e-photo-panel rise">
      <img class="e-photo-panel-bg" src="assets/images/professional-team.jpg" alt=""/>
      <div class="e-photo-panel-scrim"></div>
      <div class="e-photo-panel-content">
        <div>
          <h2>Not sure where your business stands<span class="dot">?</span></h2>
          <p>Start with a GDPR health check &mdash; a practical review, priced up front, proportionate to a business your size.</p>
        </div>
        <div class="e-photo-panel-actions">
          <a href="gdpr-health-check.php" class="pill-btn pill-btn-white">View the health check</a>
        </div>
      </div>
    </div>
  </div>
